...
/* Proposal Test cases generated on: 2011-09-22 12:01:35 : 1316685695*/
App::import('Model', 'Proposal');

class ProposalTestCase extends CakeTestCase {
	var $fixtures = array('app.proposal', 'app.retailer', 'app.deal', 'app.image', 'app.referring', 'app.subcategory', 'app.user', 'app.users_deal', 'app.deals_retailer', 'app.feedback', 'app.purchasinggap');
