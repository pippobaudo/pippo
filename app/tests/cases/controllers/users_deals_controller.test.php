...
/* UsersDeals Test cases generated on: 2011-09-22 12:09:05 : 1316686145*/
App::import('Controller', 'UsersDeals');

class TestUsersDealsController extends UsersDealsController {
...
class UsersDealsControllerTestCase extends CakeTestCase {
	...
	function startTest() {
		$this->UsersDeals =& new TestUsersDealsController();
		$this->UsersDeals->constructClasses();
	}

	function endTest() {
		unset($this->UsersDeals);
		ClassRegistry::flush();
	}
