...
/* Priceranges Test cases generated on: 2011-09-22 12:07:24 : 1316686044*/
App::import('Controller', 'Priceranges');
...
class PricerangesControllerTestCase extends CakeTestCase {
	var $fixtures = array('app.pricerange', 'app.purchasinggap', 'app.quorum', 'app.revenue', 'app.proposal', 'app.retailer', 'app.carrier', 'app.referring', 'app.image', 'app.deal', 'app.subcategory', 'app.category', 'app.user', 'app.usergroup', 'app.users_deal', 'app.feedback', 'app.deals_retailer');
