...
<?php echo $this->Form->create('Purchasinggap');?>
	<fieldset>
		<legend><?php __('Admin Edit Purchasinggap'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Purchasinggap.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Purchasinggap.id'))); ?></li>
