<div class="categories index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('subcategory_counter');?></th>
			<th><?php echo $this->Paginator->sort('subcategory_list');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $category['Category']['subcategory_counter']; ?>&nbsp;</td>
		<td><?php echo $category['Category']['subcategory_list']; ?>&nbsp;</td>
		<td class="actions">
